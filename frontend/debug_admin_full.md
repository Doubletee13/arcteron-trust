...
<head>
    ...
    <title>Users — Arcteron Trust Admin</title>
    ...
    <style>
        ...
        [data-theme="light"] .form-group input[type="datetime-local"]::-webkit-calendar-picker-indicator {
            filter: invert(0.3);
        }
...
<body>
            ...
            <div class="page-content">
                <div class="stats-row">
                    <div class="stat-card">
                        ...
                        <div class="stat-card-sub">All registered users</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-card-label">
                            <div class="stat-dot" style="background: #10B981;"></div>
                        ...
                        <div class="stat-card-value" id="statActiveUsers">0</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-card-value" id="statBlockedUsers">0</div>
                        <div class="stat-card-sub">Suspended accounts</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-card-label">
                        ...
                        <div class="stat-card-value" id="statTotalBalance">$0</div>
                        <div class="stat-card-sub">Across all accounts</div>
                    </div>
                </div>

                <div class="search-bar">
                    <input type="text" id="searchInput" placeholder="Search users by name, email, or account number..."
            ...
            <form id="createForm" onsubmit="handleCreateUser(event)">
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-wrapper">
                        <input type="password" id="createPassword" required placeholder="••••••••">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="createFirstName" required placeholder="John">
                </div>
                <div class="form-group">
                    <label>Last Name</label>
                    <input type="text" id="createLastName" required placeholder="Doe">
                </div>
                <div class="form-group">
                    <label>Initial Balance</label>
                    <input type="number" id="createBalance" step="0.01" value="0.00" placeholder="0.00">
                </div>
                <div class="form-group">
                    <label>Transaction PIN (4–6 digits)</label>
                    <div class="password-input-wrapper">
                        <input type="password" id="createPin" placeholder="••••" maxlength="6" pattern="[0-9]*"
                            inputmode="numeric">
                        <button type="button" class="password-toggle"
                            onclick="togglePasswordVisibility('createPin', this)">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-wrapper">
                        <input type="password" id="createPinConfirm" placeholder="••••" maxlength="6" pattern="[0-9]*"
                            inputmode="numeric">
                        <button type="button" class="password-toggle"
                            onclick="togglePasswordVisibility('createPinConfirm', this)">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                ...
                <div class="form-group checkbox-group">
                    <label class="checkbox-label">
                        ...
                        <span class="checkbox-text">
                            <span class="checkbox-title">Email Verified</span>
                            <span class="checkbox-description">Mark as verified to skip email verification step</span>
                        </span>
                    </label>
                </div>
    ...
    <div id="creditModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('creditModal')">&times;</button>
            </div>
            <form id="creditForm" onsubmit="handleCreditUser(event)">
                <input type="hidden" id="creditUserId">
                <div class="form-group">
                    <label>Amount (USD)</label>
                    <div class="amount-input-wrapper">
                        <span class="currency-symbol">$</span>
                        <input type="number" id="creditAmount" step="0.01" min="0" required placeholder="0.00">
                    </div>
                </div>
                <div class="form-group">
                    <label>Sender Name</label>
                    <input type="text" id="creditSenderName" required placeholder="Enter sender name">
                </div>
                <div class="form-group">
                    <label>Bank Name</label>
                    <input type="text" id="creditBankName" required placeholder="Enter bank name">
                </div>
                <div class="form-group">
                    <label>Transfer Type</label>
                    <select id="creditTransferType" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="creditDescription" placeholder="Transaction description (optional)">
                </div>
                <div class="form-group">
                    <label>Account Number (optional)</label>
                    <input type="text" id="creditAccountNumber" placeholder="Account number">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="time" id="creditTime" required>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('creditModal')">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="creditSubmitBtn">
                        <span class="btn-text">Credit Account</span>
    ...
    <div id="debitModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="closeModal('debitModal')">&times;</button>
            </div>
            <form id="debitForm" onsubmit="handleDebitUser(event)">
                <input type="hidden" id="debitUserId">
                <div class="form-group">
                    <label>Amount</label>
                    <input type="number" id="debitAmount" step="0.01" required placeholder="0.00">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input type="text" id="debitDescription" required placeholder="Transaction description">
                </div>
                <div class="form-group">
                    <label>Reason</label>
                    <textarea id="debitReason" required placeholder="Reason for debit"></textarea>
                </div>
                <div class="form-group">
                    <label>Transaction Date</label>
                ...
                <div class="form-group">
                    <label>Transaction Time</label>
                    <input type="time" id="debitTime" required>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('debitModal')">Cancel</button>
                    <button type="submit" class="btn btn-primary danger" id="debitSubmitBtn">
                        <span class="btn-text">Debit Account</span>
                        <div class="dot-loader"><span></span><span></span><span></span></div>
                    </button>
                </div>
            </form>
        ...
        <div class="modal-content">
            ...
            <form id="blockForm" onsubmit="handleBlockUser(event)">
                ...
                <div class="form-group">
                    ...
                    <textarea id="blockReason" required
                        placeholder="Explain why this account is being blocked"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('blockModal')">Cancel</button>
                    <button type="submit" class="btn btn-primary danger">Block Account</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" onsubmit="handleEditUser(event)">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" id="editEmail" required placeholder="user@example.com">
                </div>
                <div class="form-group">
                    <label>First Name</label>
                    <input type="text" id="editFirstName" required placeholder="John">
                </div>
                <div class="form-group">
                    <label>Last Name</label>
                    <input type="text" id="editLastName" required placeholder="Doe">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Address</label>
                    <textarea id="editAddress" rows="3" placeholder="Enter address"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="amount-input-wrapper">
                        <span class="currency-symbol">$</span>
                        <input type="number" id="editBalance" step="0.01" min="0" placeholder="0.00">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>New PIN (4-6 digits, leave blank to keep current)</label>
                    <div class="password-input-wrapper">
                        <input type="password" id="editPin" placeholder="••••" maxlength="6" pattern="[0-9]*" inputmode="numeric">
                        <button type="button" class="password-toggle" onclick="togglePasswordVisibility('editPin', this)">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
    ...
    <script>
        ...
        async function loadUsers() {
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json().catch(() => ({}));
                    showToast(error.detail || 'Failed to load users', 'error');
                }
            } catch (error) {
        ...
        function updateStats(users) {
            ...
            document.getElementById('statTotalBalance').textContent = `$${totalBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
        }
        ...
        function renderUsers(users) {
            ...
            users.forEach(user => {
                ...
                row.innerHTML = `
                    ...
                    <div>${user.account_number || 'N/A'}</div>
                    <div>$${user.balance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                    <div><span class="status-badge ${statusClass}">${user.status}</span></div>
                    <div><span class="role-badge ${roleClass}">${user.role}</span></div>
                    <div class="actions">
                        ...
                        <div class="actions-dropdown" id="actions-${user.id}">
                            ...
                            <button onclick="openDebitModal('${user.id}')">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <line x1="5" y1="12" x2="19" y2="12"></line>
                                </svg>
                                Debit
                            ...
                            ${user.status === 'active'
                        ? `<button onclick="openBlockModal('${user.id}')">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                                    <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                                </svg>
        ...
        async function handleEditUser(event) {
            ...
            const loader = submitBtn.querySelector('.dot-loader');
        ...
        async function promoteUser(userId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json().catch(() => ({}));
                    showToast(error.detail || 'Failed to promote user', 'error');
                }
            } catch (error) {
        ...
        async function demoteUser(userId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json().catch(() => ({}));
                    showToast(error.detail || 'Failed to demote user', 'error');
                }
            } catch (error) {
        ...
        async function handleCreateUser(event) {
            ...
            const confirmPin = document.getElementById('createPinConfirm').value;
            ...
            const data = {
                ...
                transaction_pin: pin || null,
                initial_balance: parseFloat(document.getElementById('createBalance').value),
                skip_email_verification: !document.getElementById('emailVerified').checked
            };
        ...
        // Credit user
        async function handleCreditUser(event) {
            event.preventDefault();
            const token = localStorage.getItem('admin_token');
            ...
            const time = document.getElementById('creditTime').value;
            const transactionDate = date && time ? new Date(`${date}T${time}`).toISOString() : null;

            const data = {
                amount: parseFloat(document.getElementById('creditAmount').value),
                sender_name: document.getElementById('creditSenderName').value,
                bank_name: document.getElementById('creditBankName').value,
                transfer_type: document.getElementById('creditTransferType').value,
                description: document.getElementById('creditDescription').value,
                account_number: document.getElementById('creditAccountNumber').value,
            ...
            try {
                const response = await fetch(`${API_BASE}/api/admin/users/${userId}/credit`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                ...
                if (response.ok) {
                    ...
                    showToast(error.detail || 'Failed to credit account', 'error');
                }
            } catch (error) {
                showToast('Error crediting account', 'error');
            } finally {
                // Hide loading state
                submitBtn.disabled = false;
        ...
        // Debit user
        async function handleDebitUser(event) {
            event.preventDefault();
            const token = localStorage.getItem('admin_token');
            const userId = document.getElementById('debitUserId').value;
            const submitBtn = document.getElementById('debitSubmitBtn');

            const debitDate = document.getElementById('debitDate').value;
            const debitTime = document.getElementById('debitTime').value;
            const transactionDate = new Date(`${debitDate}T${debitTime}`).toISOString();
            ...
            try {
                const response = await fetch(`${API_BASE}/api/admin/users/${userId}/debit`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                ...
                if (response.ok) {
                    ...
                    const error = await response.json();
                    showToast(error.detail || 'Failed to debit account', 'error');
                }
            } catch (error) {
                showToast('Error debiting account', 'error');
            } finally {
                // Hide loading state
                submitBtn.disabled = false;
                submitBtn.classList.remove('loading');
        ...
        async function handleBlockUser(event) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json();
                    showToast(error.detail || 'Failed to block user', 'error');
                }
            } catch (error) {
        ...
        async function unblockUser(userId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json();
                    showToast(error.detail || 'Failed to unblock user', 'error');
                }
            } catch (error) {
